...
from core.researcher._settings import settings
...
def _run_single(pdf_path: Path, dry_run: bool, topic: str | None) -> None:
    ...
    from core.researcher.agent import ResearchAgent
    from core.researcher.writer import render_note, write_note
...
def _run_batch(dry_run: bool, force: bool, max_pdfs: int = 5) -> None:
    ...
    from core.researcher.writer import write_note
