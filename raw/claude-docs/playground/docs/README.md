...
| [rag-patterns.md](architecture/rag-patterns.md) | Comprehensive RAG research reference: all chunking and retrieval strategies evaluated, CRAG implementation, reranker comparison, intent classification, multi-agent vs single-graph design, observability platform selection, production benchmarks from a v1 production deployment |
