...
**Date:** 2026-05-28
**Attendees:** Danni Gregersen, Sebastian Rose, Abhimanyu Aryan, Anders Dehn, Axel Simond, Cedric Deniau, corpus-a Quintans, Clément Gilardy, Dan Steenbjerg Rasmussen, Daniel Tadros, Dmytro Yarmak, Felix Schweickard, Hong-Thai Nguyen, Ingo Schindler, Jakob Henning Jensen, Jeremy Simon, Jonas Maia, Jonathan Coneggo, Manuel PEIXOTO, Marco Enrique Zimmermann, Marcos OLIVEIRA, Nicklas Munksgaard Larsen, Ramsey Wise, Silviu Lupu, Yan Zhang, Alex Makssoud, Vincent Salinos, Marc Roulet, Andres Arias, Olivier Chatelin, Raphael BACCONNIER, Teresa Chambel, David Gold
...
- [corpus-a Quintans] Research Langfuse Access: Research methods to switch to two-factor authentication or single sign-on for Langfuse access.
- [corpus-a Quintans] Prepare MCP Discussion: Coordinate with team members to share experience regarding MCP server usage for the next meeting.
...
**Banking team (corpus-a Quintans / Jonas Maia):**
...
### Langfuse Legal & Security Update (corpus-a Quintans)

- Legal review is complete.
- Contract being finalized to align with client-a's requirements (needed before production data use).
...
- corpus-a Quintans: team member participated in hackathon MCP server group; will coordinate to share insights.
