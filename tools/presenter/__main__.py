...
def run_deck(dry_run: bool = False) -> None:
    from tools.presenter.image_fetcher import fetch_images_for_slides
    from tools.presenter.intake import collect_deck_intake
    from tools.presenter.outline import approval_checkpoint, generate_outline
    from tools.presenter.renderer import render_deck
    from tools.presenter.slide_writer import generate_slide_content
    from tools.presenter.viz_classifier import classify_slides
...
def run_image() -> None:
    from tools.presenter.image_fetcher import fetch_single_image
    from tools.presenter.intake import collect_image_intake
    from tools.presenter.viz_classifier import propose_image_concepts
